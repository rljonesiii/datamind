...
using DataFrames  # Add DataFrames import for nrow, ncol, etc.
...
@testset "Julia ML Optimization Tests" begin
    ...
    @testset "Feature Standardization" begin
        ...
        # Create test matrix with proper broadcasting
        ...
        @test std(X_zscore) > 0.5  # Standard deviation should be reasonable after standardization
